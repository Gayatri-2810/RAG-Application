...
os.environ["GEMINI_API_KEY"] = "AIzaSyBnVDPJc2RyJpzxVmdRgCTzahXa0qNYIOg"
...
Web-Development.webpWeb-Development.webp
Basic Code Example
...
prompt = PromptTemplate(
    ...
    template = """ Use only the context below to answer the question. context: {context} question : {question} Answer : """
)
